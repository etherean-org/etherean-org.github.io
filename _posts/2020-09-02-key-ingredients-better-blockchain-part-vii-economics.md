...
[^5]: Uniswap has never had its own token. It raised money by [selling equity](https://www.bamsec.com/filing/177518020000001?cik=1775180) to VCs. Each token pair traded on the platform causes a new token to be minted to represent the liquidity pool associated with that pair, but there is no Uniswap token. [NOTE: Since this article was published, Uniswap has issued a [new governance token](https://uniswap.org/blog/uni/). However, I remain impressed with how far the platform got without one!]
